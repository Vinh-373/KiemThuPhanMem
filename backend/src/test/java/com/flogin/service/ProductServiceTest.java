...
class ProductServiceTest {
    ...
    void testPagination() {
        for (int i = 1; i <= 10; i++) {
            productService.createProduct(new Product("Product" + i, new BigDecimal(String.valueOf(100 * i)), i));
        }
    ...
    void testConvertToDto() {
        ...
        assertEquals(new BigDecimal("1000"), dto.getPrice());
    ...
    void testConvertToEntity() {
        ...
        assertEquals(new BigDecimal("1000"), entity.getPrice());
