...
class ProductControllerIntegrationTest {
    ...
    void testCreateProduct() throws Exception {
        // GIVEN
        ProductDto newProductRequest = new ProductDto(null, "Keyboard", 800000, 25, "Desc", "img.png", "Company");
        // Giả định ID được gán (vì service giả định của bạn gán ID bằng System.currentTimeMillis())
        ProductDto createdProductResponse = new ProductDto(12345678L, "Keyboard", 800000, 25, "Desc", "img.png", "Company");
    ...
    void testGetAllProducts() throws Exception {
        ...
        List<ProductDto> products = Arrays.asList(
                new ProductDto(1L, "Laptop", 15000000, 10, null, null, null),
                new ProductDto(2L, "Mouse", 200000, 50, null, null, null)
        );
    ...
    void testGetProductById_Existing() throws Exception {
        // GIVEN
        ProductDto product = new ProductDto(EXISTING_ID, "Monitor", 5000000, 5, null, null, null);
    ...
    void testUpdateProduct_Existing() throws Exception {
        // GIVEN
        ProductDto updatedDetails = new ProductDto(EXISTING_ID, "Updated Speaker", 3500000, 15, "new desc", "new img", "new comp");
