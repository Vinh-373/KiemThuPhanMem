...
public class ProductService {
    ...
    public ProductDto get_ProductById(int id) {
        // Thực tế sẽ gọi Repository
        return null; 
    }
    ...
    public ProductDto create_Product(ProductDto productDto) {
        ...
        productDto.setId((int)System.currentTimeMillis()); // Giả định Id
        return productDto;
    }
    
    public ProductDto update_Product(int id, ProductDto productDto) {
